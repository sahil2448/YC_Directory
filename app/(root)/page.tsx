...
const Home = async({searchParams}:{searchParams:Promise<{query?:string}>}) => {
  ...
  const {data:posts} = await sanityFetch({query:STARTUPS_QUERY,params}) // This will keep the content updated automatically whenever content changes...will not need to wait for 60 secs like previous method
  // const posts = [{
  //   _createdAt:new Date(),
  //   views:55,
